...
import { ClasesAnterioresClient } from "./ClasesAnterioresClient";

type Params = { params: Promise<{ slug: string }> };

export default async function ClasesAnterioresPage({ params }: Params) {
  ...
  return <ClasesAnterioresClient slug={slug} adminId={school.id} />;
}
