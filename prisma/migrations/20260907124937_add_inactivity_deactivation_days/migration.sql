...
INSERT INTO "new_Admin" ("active", "approved", "attendanceRadiusMeters", "contactEmail", "contactPhone", "createdAt", "currentPeriodEnd", "displayName", "graceEndsAt", "id", "latitude", "longitude", "mpPayerEmail", "mpPreapprovalId", "passwordHash", "pendingChangeCodeHash", "pendingChangeExpiresAt", "pendingChangeType", "pendingChangeValue", "periodWarningSentAt", "role", "slug", "subscriptionStatus", "trialEndsAt", "trialWarningSentAt", "twoFactorBackupCodes", "twoFactorEnabled", "twoFactorSecret", "username") SELECT "active", "approved", "attendanceRadiusMeters", "contactEmail", "contactPhone", "createdAt", "currentPeriodEnd", "displayName", "graceEndsAt", "id", "latitude", "longitude", "mpPayerEmail", "mpPreapprovalId", "passwordHash", "pendingChangeCodeHash", "pendingChangeExpiresAt", "pendingChangeType", "pendingChangeValue", "periodWarningSentAt", "role", "slug", "subscriptionStatus", "trialEndsAt", "trialWarningSentAt", "twoFactorBackupCodes", "twoFactorEnabled", "twoFactorSecret", "username" FROM "Admin";
DROP TABLE "Admin";
